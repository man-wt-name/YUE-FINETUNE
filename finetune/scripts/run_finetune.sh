...
DATA_PATH="${DATA_PATH:-<weight_and_path_to_data_X>}"     
DATA_CACHE_PATH="${DATA_CACHE_PATH:-<path_to_tokenizer_model>}"

# Set comma-separated list of proportions for training, validation, and test split
DATA_SPLIT="900,50,50"

# Model configuration
TOKENIZER_MODEL_PATH="${TOKENIZER_MODEL_PATH:-<path_to_tokenizer_model>}"
MODEL_NAME="${MODEL_NAME:-m-a-p/YuE-s1-7B-anneal-en-cot}"
MODEL_CACHE_DIR="${MODEL_CACHE_DIR:-<path_to_model_cache>}"
...
# ==============================
# Print all key environment variables for debug
